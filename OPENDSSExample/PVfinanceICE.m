...
TR1=88; % colones por primeros 200 kWh
TR2=156; % colones por siguientes 100 kWh
TR3=156; % colones por kWh adicional
aumcostel=0.05; % electricity cost increase / year
 
ppkWh=27; % valor de peaje en colones / kWh
aumpeaje=0.01; % aumento anual del costo de acceso a la red
...
dr=0.07; % tasa de descuento (discount rate)
...
str2=sprintf('PV de %d kW, ICE (inc. tar. %2.1f%%). Consumo %d kWh (inc. %2.1f%%), producción %2.1f kWh (deg. %2.1f%%) al año 0. Peaje %d col/kWh (inc. %2.1f%%). Financiamiento del %d%% ',kWinstal,aumcostel*100,kWhLoadmes,loadgwrt*100,kWhPVmes,PVdeg*100,ppkWh,aumpeaje*100,perloan*100);
title(str2)
ylabel('Colones')
