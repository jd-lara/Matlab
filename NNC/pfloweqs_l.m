...
Pg4*3.919184e-01-Ql(4)-imag(-1.0*(V4*cos(d4) + V4*sin(d4)*(1.0*i + 0.0))*(V3*cos(d3)*(1.7142*i + 3.4473) + V4*cos(d4)*(- 1.7142*i - 3.4473) + V3*sin(d3)*(1.7142 - 3.4473*i) + V4*sin(d4)*(3.4473*i - 1.7142)));
...
Pg5*3.919184e-01-Ql(5)-imag(-1.0*(V5*cos(d5) + V5*sin(d5)*(1.0*i + 0.0))*(V3*cos(d3)*(2.0673*i + 3.9257) + V5*cos(d5)*(- 2.0673*i - 3.9257) + V3*sin(d3)*(2.0673 - 3.9257*i) + V5*sin(d5)*(3.9257*i - 2.0673)));
];