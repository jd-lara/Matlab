...
fl = @(x)((losses_approx(x,S)-6.889311e-02)/8.151656e-02);
...
res(k,:)=x';
% plot3((-1*x(2)-1*(-1.200000e-01))/1.080000e-01,...
%       (-1*x(3)-1*(-1.200000e-01))/1.080000e-01,...
%      (losses_approx(x,S)-6.889311e-02)/8.151656e-02,'*r'); 
plot3(-1*x(2),...
      -1*x(3),...
      losses_approx(x,S),'og');
