...
ceq_nnc = [Pg1-Pl(1)-real((V1*cos(d1) + V1*sin(d1)*(1.0*i + 0.0))*(V1*cos(d1)*(3.4497*i + 6.0654) + V2*cos(d2)*(- 3.4497*i - 6.0654) + V1*sin(d1)*(3.4497 - 6.0654*i) + V2*sin(d2)*(6.0654*i - 3.4497)));
