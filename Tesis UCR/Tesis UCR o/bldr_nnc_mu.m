...
S.Bus.Generation(5,1)=0.12*(1+1j*s);
S=pflow(S);
anchor1=[losses_exact(S); -0.12; -0.12];
...
% plot3([anchor11(2,1),anchor2(2,1)], [anchor11(3,1),anchor3(3,1)], [anchor11(1,1),anchor1(1,1)],'r'); hold on; grid
...
% plot3([anchor11(2,1)], [anchor11(3,1)], [anchor11(1,1)],'*b')
...
% figure
% plot3([norm_anchor1(2,1),norm_anchor2(2,1)], [norm_anchor1(3,1),norm_anchor3(3,1)], [norm_anchor1(1,1),0],'r'); hold on
% plot3([norm_anchor2(2,1),norm_anchor2(2,1)], [norm_anchor2(3,1),norm_anchor3(3,1)], [norm_anchor2(1,1),0],'r');
% plot3([norm_anchor3(2,1),norm_anchor2(2,1)], [norm_anchor3(3,1),norm_anchor3(3,1)], [norm_anchor3(1,1),0],'r');
...
% plot3([norm_anchor1(2,1), norm_anchor2(2,1)], [norm_anchor1(3,1), norm_anchor2(3,1)],[norm_anchor1(1,1), norm_anchor2(1,1)]); hold on;
