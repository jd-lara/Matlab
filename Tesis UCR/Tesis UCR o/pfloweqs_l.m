...
Pg11*3.919184e-01-Ql(11)-imag(-1.0*(V11*cos(d11) + V11*sin(d11)*(1.0*i + 0.0))*(V10*cos(d10)*(52.393*i + 47.63) + V11*cos(d11)*(- 52.393*i - 47.63) + V10*sin(d10)*(52.393 - 47.63*i) + V11*sin(d11)*(47.63*i - 52.393)));
...
Pg15*3.919184e-01-Ql(15)-imag(-1.0*(V15*cos(d15) + V15*sin(d15)*(1.0*i + 0.0))*(V14*cos(d14)*(32.256*i + 51.976) + V15*cos(d15)*(- 32.256*i - 51.976) + V14*sin(d14)*(32.256 - 51.976*i) + V15*sin(d15)*(51.976*i - 32.256)));
...
Pg22*3.919184e-01-Ql(22)-imag(-1.0*(V22*cos(d22) + V22*sin(d22)*(1.0*i + 0.0))*(V20*cos(d20)*(51.068*i + 24.697) + V22*cos(d22)*(- 51.068*i - 24.697) + V20*sin(d20)*(51.068 - 24.697*i) + V22*sin(d22)*(24.697*i - 51.068)));
...
Pg37*3.919184e-01-Ql(37)-imag(-1.0*(V37*cos(d37) + V37*sin(d37)*(1.0*i + 0.0))*(V36*cos(d36)*(18.62*i + 17.019) + V37*cos(d37)*(- 18.62*i - 17.019) + V36*sin(d36)*(18.62 - 17.019*i) + V37*sin(d37)*(17.019*i - 18.62)));
...
Pg38*3.919184e-01-Ql(38)-imag(-1.0*(V38*cos(d38) + V38*sin(d38)*(1.0*i + 0.0))*(V36*cos(d36)*(18.668*i + 19.215) + V38*cos(d38)*(- 18.668*i - 19.215) + V36*sin(d36)*(18.668 - 19.215*i) + V38*sin(d38)*(19.215*i - 18.668)));
