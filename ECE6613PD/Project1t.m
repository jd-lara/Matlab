...
% Ybus1t = [1/Zline(1,2)+Bline(1,2)/2+1/Zline(1,5)+Bline(1,5)/2+1/Zg1(1) -1/Zline(1,2) 0 0 -1/Zline(1,5) 0 0 0 0 0 0 0 0 0
...
% Ybus0t = [1/(Zline(1,2)*3)+Bline(1,2)*3/2+1/(Zline(1,5)*3)+Bline(1,5)*3/2+1/Zg0(1) -1/(Zline(1,2)*3) 0 0 -1/(Zline(1,5)*3) 0 0 0 0 0 0 0 0 0
...
Yf012_3=(A^-1)*[9e10 0 0;0 9e10 0;0 0 9e10]*A;
...
If012_12=((Yf012_1*Z14_012+eye(3)))\Yf012_1*[V0_pf(14);V1_pf(14);V2_pf(14)];
...
If012_2=((Yf012_3*Z14_012+eye(3)))\Yf012_3*[V0_pf(14);V1_pf(14);V2_pf(14)];
...
If012_1_9to14=[(V0_f1(9)-V0_f1(14))*(-Ybus0t(9,14)); (V1_f1(9)-V1_f1(14))*(-Ybus1t(9,14)); (V2_f1(9)-V2_f1(14))*(-Ybus1t(9,14))];
...
If012_1_13to14=[(V0_f1(13)-V0_f1(14))*(-Ybus0t(13,14)); (V1_f1(13)-V1_f1(14))*(-Ybus1t(13,14)); (V2_f1(13)-V2_f1(14))*(-Ybus1t(13,14))];
...
If012_3_9to14=[(V0_f3(9)-V0_f3(14))*(-Ybus0t(9,14)); (V1_f3(9)-V1_f3(14))*(-Ybus1t(9,14)); (V2_f3(9)-V2_f3(14))*(-Ybus1t(9,14))];
...
If012_3_13to14=[(V0_f3(13)-V0_f3(14))*(-Ybus0t(13,14)); (V1_f3(13)-V1_f3(14))*(-Ybus1t(13,14)); (V2_f3(13)-V2_f3(14))*(-Ybus1t(13,14))];
